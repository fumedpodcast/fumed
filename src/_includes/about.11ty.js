	...
	let headshots = [
		{
			...
			bio: "Host: David Leffler is a staff writer and investigative journalist at Public Health Watch who covers toxic chemical pollution in Texas. ",
			name: "David Leffler",
			alt: "David Leffler",
		},
		{
			image: "/assets/imgs/headshots/Headshot_White_BW_crop.png",
			bio: "Editor: Susan White has edited Pulitzer Prize-winning projects at InsideClimate News, ProPublica and the San Diego Union-Tribune. She has also edited two podcasts: Room 20 for the LA Times Studios and Border City for the Union-Tribune.",
			name: "Susan White",
			alt: "Susan White",
		},
		{
			image: "/assets/imgs/headshots/Headshot_Gass_Poore__BW_crop.png",
			bio: "Executive Producer: Jordan Gass-Pooré is an award-winning climate journalist and podcaster. She’s the creator and host of the podcasts “Hazard NJ” and “Hazard NYC,” which examine serious pollution issues. ",
			name: "Jordan Gass-Pooré",
			alt: "Jordan Gass-Pooré",
		},
		{
			image: "/assets/imgs/headshots/Headshot_Arredondo_BW_crop.png",
			bio: "Senior Producer: Salina Arredondo is a Washington-based podcast producer and investigative journalist with in-depth knowledge about petrochemical barge regulation.",
			name: "Salina Arredondo",
			alt: "Salina Arredondo",
		},
		{
			image: "/assets/imgs/headshots/Headshot_Strott_BW_crop.png",
			bio: "Assistant Producer: Savanna Strott is a staff writer and investigative journalist at Public Health Watch who specializes in data analysis and government accountability.",
			name: "Savanna Strott",
			alt: "Savanna Strott",
		},
		{
			image: "/assets/imgs/headshots/Headshot_Cholakovska_BW_crop.png",
			bio: "Researcher: Jana Cholakovska is an investigative reporter covering the environment, climate, and public health.",
			name: "Jana Cholakovska",
			alt: "Jana Cholakovska",
		},
		{
			image: "/assets/imgs/headshots/Headshot_Jim_Morris_BW_crop.png",
			bio: "Editor-in-Chief: Jim Morris is the founder of Public Health Watch and has been a journalist since 1978, focusing on public health and the environment.",
			name: "Jim Morris",
			alt: "Jim Morris",
		},
		{
			image: "/assets/imgs/headshots/Mark_BushHeadshot.png",
			bio: "Sound Engineer: Mark Bush is a professional audio engineer, sound designer, musician, and composer with a diverse background in audio production and music performance.",
			name: "Mark Bush",
			alt: "Mark Bush",
		},
		{
			image: "/assets/imgs/headshots/Michael_RamosHeadshot.png",
			bio: "Original Music: Michael Ramos is a Grammy-winning musician, producer, and composer.",
			name: "Michael Ramos",
			alt: "Michael Ramos",
		},
	];
